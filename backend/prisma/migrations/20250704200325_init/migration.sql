-- CreateEnum
CREATE TYPE "Currency" AS ENUM ('UNITS', 'TOINS');
...
CREATE TABLE "users" (
    ...
    "personalityId" TEXT,
    "currentStage" TEXT NOT NULL DEFAULT 'BUYER',
    "stageCompletionData" JSONB,
    "stageProgressedAt" TIMESTAMP(3),
...
CREATE TABLE "wallets" (
    ...
    "balanceUnits" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "balanceToins" DECIMAL(65,30) NOT NULL DEFAULT 0,
