...
export class UsersController {
  constructor(
    ...
    console.log(
      'UsersController constructor - service:',
      this.usersService ? 'available' : 'undefined'
    );
    console.log(
      'UsersController constructor - service type:',
      typeof this.usersService
    );
    console.log(
      'UsersController constructor - service constructor:',
      this.usersService?.constructor?.name
    );
  }
  ...
  @Get('test')
  @ApiOperation({
    summary: 'Test endpoint para verificar que el controlador funciona',
  })
  async test() {
    return {
  ...
  @Roles('admin')
  @ApiOperation({
    summary: 'Simple endpoint para obtener usuarios sin paginación',
  })
  async findAllSimple() {
  ...
  async dbTest() {
    try {
      ...
      console.log(
        'UsersController.dbTest - service check:',
        !!this.usersService
      );
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        reciprocityScore: {
          type: 'number',
          description: 'Puntuación de reciprocidad',
        },
        elementos: {
          type: 'object',
          properties: {
            ...
            tierra: {
              type: 'number',
              description: 'Puntos de elemento Tierra',
            },
        ...
        positiveImpact: {
          type: 'number',
          description: 'Impacto positivo generado',
        },
        communityRank: {
          type: 'number',
          description: 'Ranking en la comunidad',
        },
        weeklyGrowth: {
          type: 'number',
