...
const mockChallenges: Challenge[] = [
  {
    id: '1',
    title: 'Equilibrio Elemental Maestro',
    description:
      'Mantén balance perfecto entre todos los elementos durante 5 días',
    category: 'individual',
    difficulty: 'epic',
    element: 'power',
    progress: 3,
    ...
    rewards: {
      ...
      badges: ['Maestro Elemental', 'Equilibrista'],
    },
    status: 'active',
  ...
  },
  {
    ...
    description:
      'Colabora con 10 miembros diferentes en proyectos de bien común',
    category: 'community',
    difficulty: 'medium',
    element: 'earth',
    progress: 6,
  ...
  {
    id: '3',
    title: 'Exploradores UPlay',
    description: 'Ve 15 videos interactivos y responde todas las preguntas',
    category: 'individual',
    difficulty: 'easy',
    element: 'fire',
    progress: 11,
  ...
  {
    id: '4',
    title: 'Sabios del Conocimiento',
    description: 'Equipo de 5 personas debe completar un curso certificado',
  ...
  {
    id: '5',
    title: 'Maratón de Sostenibilidad',
    description: 'Evento global: contribuye a 20 acciones de sostenibilidad',
    category: 'community',
    difficulty: 'medium',
    element: 'water',
    progress: 245,
