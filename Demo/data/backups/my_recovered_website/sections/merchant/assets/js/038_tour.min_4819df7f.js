window.Tour = (function(t) {
	(t.prototype.init = function(t) {
		...
		(t.prototype.showStep = function(t) {
			var n = v(t.element, this.container, this.padding, this),
				i = e(this, '.ttour-wrapper'),
				o = e(this, '.ttour-tip');
			o && i.removeChild(o),
				(o = s.call(this, t, t.position || 'bottom')),
				i.appendChild(o),
	...
	var e = function(t, e) {
		...
		c = function() {
			...
			return (
				this.current > 0 && t.push(d.call(this)),
				y(
					'div',
					{
		...
		v = function(t, e, n, self) {
			var i = (e.querySelector(t) || e).getBoundingClientRect();

			/* console.log('EL: ', e.querySelector(t));
            console.log('EL2: ', jQuery(t));
            console.log('EL3: ', self.nextStep);
            console.log('EL4: ', getAllFuncs(self)); */

			if (jQuery(t).length <= 0) {
				if (self.steps.length > self.current + 1) {
					self.nextStep.bind(this);
				} else {
					self.container.removeChild(self.el), (self.el = null);
				}
				return;
			}
