...
/**
 * 🏪⚜️ MARKETPLACE PAGE - CONCILIO DE GUARDIANES ACTIVADO
 *
 * Esta página sirve como wrapper para el componente MarketplaceMain
 * que contiene todas las implementaciones conscientes del Concilio de Guardianes:
 *
