...
const getCategoryColor = (category: string) => {
  const styles: { [key: string]: string } = {
    ...
    "UX/UI Design": "bg-purple-100 text-purple-800",
  ...
  return (
    <LazyLoadComponent>
      <motion.div
        ...
        className="group relative overflow-hidden bg-white/95 backdrop-blur-xl rounded-2xl border border-white/20 p-6 shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col"
