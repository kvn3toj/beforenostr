  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'nav-menu-background': 'var(--nav-menu-background)',
        'nav-menu-text': 'var(--nav-menu-text)',
        'nav-menu-item-active': 'var(--nav-menu-item-active)',
        ...
        'loading-placeholder-background': 'var(--loading-placeholder-background)',
