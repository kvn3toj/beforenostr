      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 opacity-100 transition-opacity hover:opacity-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <button onClick={toggleMute} className="text-white focus:outline-none" aria-label={muted ? 'Unmute' : 'Mute'}>
          ...
          {/* Fullscreen Button */}
          <button onClick={toggleFullscreen} className="text-white focus:outline-none" aria-label={fullscreen ? 'Exit fullscreen' : 'Enter fullscreen'}>
