...
INSERT INTO "new_video_items" ("content", "createdAt", "deletedAt", "description", "duration", "id", "isActive", "isDeleted", "itemTypeId", "order", "playlistId", "title", "updatedAt") SELECT "content", "createdAt", "deletedAt", "description", "duration", "id", "isActive", "isDeleted", "itemTypeId", "order", "playlistId", "title", "updatedAt" FROM "video_items";
