...
export class GetAuditLogsDto {
  ...
  @ApiProperty({ description: 'Filter by start date (ISO 8601 string)', required: false })
  @IsDateString()
  @IsOptional()
  startDate?: string;

  @ApiProperty({ description: 'Filter by end date (ISO 8601 string)', required: false })
  @IsDateString()
  @IsOptional()
  endDate?: string;

  @ApiProperty({ description: 'Limit the number of results', required: false, default: 10 })
  @Type(() => Number)
  @IsInt()
  @Min(1)
  @IsOptional()
