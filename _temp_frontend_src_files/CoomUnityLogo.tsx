...
export interface CoomUnityLogoProps {
...
const sizeMap = {
  ...
  medium: { width: 180, height: 43 },
  large: { width: 250, height: 60 },
  xlarge: { width: 320, height: 77 }
};

export const CoomUnityLogo: React.FC<CoomUnityLogoProps> = ({
  size = 'medium',
  variant = 'full',
  clickable = true,
  sx = {},
    ...
    >
      <g>
        <g>
          <g>
            <g>
              <polygon fill={color} points="220.398,57.161 228.715,57.161 245,20.911 236.753,20.911 230.466,34.885 223.409,20.911 214.823,20.911 226.364,43.918" />
            </g>
            <g opacity="0.3">
              <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="222.8407" y1="32.4124" x2="222.6478" y2="27.976">
                <stop offset="0" style={{stopColor: color, stopOpacity: 0}} />
                <stop offset="0.0454" style={{stopColor: '#F7F7F7', stopOpacity: 0.0454}} />
                <stop offset="0.5073" style={{stopColor: '#ADABAA', stopOpacity: 0.5073}} />
                <stop offset="0.8367" style={{stopColor: '#7F7B7A', stopOpacity: 0.8367}} />
                <stop offset="1" style={{stopColor: '#6D6968'}} />
              </linearGradient>
              <polygon fill="url(#SVGID_1_)" points="230.466,34.885 223.409,20.911 214.823,20.911 226.364,43.918" />
            </g>
            <path fill={color} d="M218,42.934l-0.36,0.141c-0.865,0.34-1.741,0.513-2.604,0.513c-1.049,0-1.865-0.271-2.492-0.828
            ...
            <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="195.0206" y1="24.8827" x2="210.0667" y2="24.8827">
              <stop offset="0.0587" style={{stopColor: '#6D6968'}} />
              <stop offset="0.7626" style={{stopColor: color, stopOpacity: 0}} />
            </linearGradient>
            <rect x="189.756" y="20.91" opacity="0.3" fill="url(#SVGID_2_)" width="15.046" height="7.946" />
            <path fill={color} d="M189.727,50.594V20.911h7.77v29.683H189.727z M193.612,16.198c1.142,0,2.222-0.5,2.962-1.371
          ...
          <path fill={color} d="M113.969,50.595c0,0,0-14.999,0-15.039h-0.003c-0.01-0.782-0.153-1.551-0.425-2.286
          ...
          <path fill={color} d="M179.237,50.595V35.676c0-3.856-3.137-6.994-6.994-6.994s-6.994,3.137-6.994,6.994v0.092h-7.771v-0.092
          ...
          <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="120.6453" y1="28.3394" x2="142.2715" y2="28.3394">
            <stop offset="0.2374" style={{stopColor: color, stopOpacity: 0}} />
            <stop offset="0.9413" style={{stopColor: '#6D6968'}} />
          </linearGradient>
          ...
          <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="159.5234" y1="28.3394" x2="182.2865" y2="28.3394">
            <stop offset="0.0587" style={{stopColor: '#6D6968'}} />
            <stop offset="0.7626" style={{stopColor: color, stopOpacity: 0}} />
          </linearGradient>
          <path opacity="0.3" fill="url(#SVGID_4_)" d="M178.955,22.551c-2.021-1.045-4.304-1.64-6.712-1.64c-2.5,0-4.966,0.634-7.13,1.834
            ...
            V22.551z" />
          <path fill={color} d="M150.488,55.082c-8.036,0-14.658-6.533-14.761-14.564c-0.003-0.062-0.003-0.131-0.003-0.197V15.107h7.771
          ...
          <path fill={color} d="M28.325,42.346c-1.065,0.304-2.187,0.472-3.349,0.472c-6.743,0-12.209-5.466-12.209-12.209
  ...
  return (
    <Box
      ...
      aria-label={clickable ? "Ir al inicio" : "Logo CoomÜnity Gamifier"}
    >
      {renderLogo()}
    </Box>
  );
