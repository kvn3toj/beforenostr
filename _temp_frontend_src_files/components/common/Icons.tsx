// Centralized icon imports to avoid EMFILE issues
// Import only specific icons instead of the entire @mui/icons-material package
...
export {
  ...
  BackupIcon as Backup,
  RestoreIcon as Restore,
  SearchIcon as Search,
  ToggleOnIcon as ToggleOn,
  ToggleOffIcon as ToggleOff,
  ViewListIcon as ViewList,
  ViewModuleIcon as ViewModule,
  VisibilityIcon as Visibility,
  PreviewIcon as Preview,
  AccountTreeIcon as AccountTree,
  SettingsIcon as Settings,
  CategoryIcon as Category,
  PlayCircleOutlineIcon as PlayCircleOutline,
  ListAltIcon as ListAlt,
  StarIcon as Star,
  SmartToyIcon as SmartToy,
  ...
  PushPinOutlinedIcon as PushPinOutlined,
