# 🎭 CÓMO USAR EL SISTEMA DE INVOCACIÓN DE GUARDIANES DIGITALES
...
| # | Guardián | Especialidad | Filosofía | Casos de Uso |
|---|----------|-------------|-----------|--------------|
...
### **Al invocar ARIA para un componente:**
```jsx
